  ...
  <div>
    ...
    <el-form class="form-con" :model="formData" size="small" :rules="rules" ref="ruleForm">
      ...
      <el-form-item class="smsCode" prop="smsCode">
        ...
        <el-button @click="getSmsCode" :disabled="verifyCode.disabled" type="primary">{{verifyCode.content}}</el-button>
      </el-form-item>
      ...
      <el-form-item>
        <el-button native-type="submit" style="width: 100%" @click="updatePassword" type="primary">重置密码</el-button>
      </el-form-item>
...
<script>
import { getSmsCode_api, updatePassword_api } from '_api/login';
